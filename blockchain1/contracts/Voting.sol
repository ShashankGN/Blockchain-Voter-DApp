...
contract Voting is ERC20 {
    ...
    mapping(address=>bool)public hasTokenorNot;
    ...
    ) ERC20("Votingclub ERC20 TOKEN","VCT")
    {
    ...
    function voteForCandidate(bytes32 candidate, uint256 votesInTokens) public {
        ...
        require(hasTokenorNot[msg.sender],"No ERC20 Tokens");
